...
\]
and $\MC^+_{\psi}(\RRP)$ its restriction to positive measures. This set is the set of finite measures with $\psi$-moment. A natural norm on these weighted spaces is the $\psi$-weighted total variation norm:
\[
...
\]
Let $Lip_1(d_{p\alpha})$ be the space of Lipschitz functions for $d_{p\alpha}$ defined by:
\[
