...
\begin{itemize}
    \item \red{SC}
    \item \red{Wass}
    \item \red{Theorème pricipal}
    \item \red{Assumptions}
    \item \red{Sketch of main proof with theorem 1 avec Semigroup, theorem 2 Wasserstei rgularity}
\end{itemize}
...
\section{The Smoluchovski coagulation equation and its derivative}
...
\end{equation*}
In this section we prove that it is well-posed in the sense that for $\mu \in \MC^+_{\psi_2}(\RRP)$ it has a unique solution in:
\[
...
In this section we assume the well-posedness of both the Smoluchovski coagulation equation as well as its first derivative. We recall that the solution of the \(\SCE\) is a positive measure. The first lemma give a result of stability of solutions of the \(\SCE\) and hold for all kernels.
