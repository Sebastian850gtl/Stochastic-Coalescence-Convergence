...
\begin{proof}
    ...
    \begin{align*}
        \brac{1,\varphi_t(\mu)-\varphi_t(\tilde{\mu})} =& \brac{1,\mu-\nu} - \int_0^t \brac{K_\alpha ,\left( \varphi_s(\mu)+\varphi_s(\tilde{\mu})\right)\otimes\left(\varphi_s(\mu)-\varphi_s(\tilde{\mu})\right)}\dd s \\
        =& \brac{1,\mu-\nu} - \int_0^t \brac{1,\varphi_s(\mu)-\varphi_s(\tilde{\mu})}\int_{\RRP} x^{-\alpha} \left(\varphi_s(\mu)+\varphi_s(\tilde{\mu})\right)(\dd x) \dd s \\
        &- \int_0^t \brac{1,\varphi_s(\mu)+\varphi_s(\tilde{\mu})} \int_{\RRP} x^{-\alpha} \left(\varphi_s(\mu)+\varphi_s(\tilde{\mu})\right)(\dd x) \dd s\\
        \leq& \brac{1,\mu-\nu} - \int_0^t \brac{1,\varphi_s(\mu)-\varphi_s(\tilde{\mu})}\int_{\RRP} x^{-\alpha} \left(\varphi_s(\mu) + \varphi_s(\tilde{\mu})\right)(\dd x) \dd s\\
        &+ \int_0^t \brac{1,\varphi_s(\mu)+\varphi_s(\tilde{\mu})} W_{1,\psi_1}^L\left(\varphi_s(\mu),\varphi_s(\tilde{\mu})\right) \dd s
    \end{align*}
    and therefore by Gronwall lemma,
    \begin{multline*}
        \brac{1,\varphi_t(\mu)-\varphi_t(\tilde{\mu})} \leq \left(\brac{1,\mu-\nu} + \int_0^t \brac{1,\varphi_s(\mu)+\varphi_s(\tilde{\mu})} W_{1,\psi_1}^L\left(\varphi_s(\mu),\varphi_s(\tilde{\mu})\right) \dd s\right) \\
        \times e^{-\int_0^t \int_{\RRP} x^{-\alpha} \left(\varphi_s(\mu) + \varphi_s(\tilde{\mu})\right)(\dd x) \dd s}\\
