...
\Section{\red{Wasserstein distance}}
...
\begin{proof}
    ...
    \begin{align*}
        \left|H_tf(x,y) - \tilde{H}_tf(x,y)\right| &\leq \left(1 + \psi_{p}(x + y) \right)\left(1 + \psi_{2}(x) \right)\left(1 + \psi_{2}(y) \right)\int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s)\dd s\\
