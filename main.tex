...
\begin{proposition}\label{prop:wass-derivaitve}
    ...
    \end{align*}
\end{proposition}
% \red{Ancienne preuve, nouvelle preuve en dessous.}
% \begin{proof}
%     Let $f\in C_b(\RRP)$ recall that for all $z \in \RRP$:
%     \begin{align*}
%         \brac{f,\delta_\mu\varphi_t(\mu;z)} = f(z) + \int_0^t \brac{K_\alpha f, \varphi_s(\mu)\otimes\delta_\mu\varphi_s(\mu;z)} \dd s\ .
...
\begin{proof}
    ...
    \begin{multline*}
        ...
        \leq 2\alpha x^{-1-\alpha} \|\mu\|_{\psi_1}\ .
    \end{multline*}
    In conclusion we found that the previous function $A_tf$ is Lipschitz with a Lip pseudo norm smaller than $C\times(1 + \gamma_t )\|\mu\|_{\psi_2}$ from our original equation \eqref{eq:proof:wass-derivaitve} we have:
    \begin{multline*}
        \brac{fh_t,\delta_\mu\varphi_t(\mu;z_1) -\delta_\mu\varphi_t(\mu;z_2)} \\
        = f(z_1) - f(z_2) + \int_0^t \brac{A_sf,h_s\delta_\mu\varphi_s(\mu;z_1) - h_s\delta_\mu\varphi_s(\mu;z_2)} \dd s \\
...
\begin{proposition}\label{prop:wass-sce}
    For all $t \in [0,T]$:
    \begin{align*}
...
\begin{lemma}\label{lem:technical_G_h}
    ...
    \begin{align*}
        G_{t}(x,y) &= K_\alpha(x,y) h_t(x+y)\left( h_t(x)\right)^{-1}\\
         &=  K_\alpha(x,y) e^{\int_0^t \int_{\RRP} K_\alpha(x+y,z) - K_\alpha(x,z) \mu_s(\dd z) \dd s}\\
         &=  K_\alpha(x,y) e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\int_0^t \brac{1,\mu_s} \dd s}\ .
    \end{align*}
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \item For all $x \in \RRP$, $\left|\left( h_t(x)\right)^{-1}-\left( \tilde{h}_t(x)\right)^{-1} \right|\leq (1 + x^{-\alpha})\int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s) \dd s$.
        \item For all $x \in \RRP$, $(1 + x^{-\alpha})\left|\partial_x \left( h_t(x)\right)^{-1}- \partial_x\left( \tilde{h}_t(x)\right)^{-1} \right|\leq \alpha \left(1 + t\|\mu\| \right)x^{-1-\alpha} \left(1 + t\|\mu\| \right) \int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s) \dd s$.
        \item For all $x,y \in \RRP$, $|G_t(x,y)| \leq (1 + x^{-\alpha})(1 + y^{-\alpha})$.
        \item For all $x,y \in \RRP$, $\left|\partial_x G_t(x,y) \right| \leq C \alpha  x^{-1-\alpha}e^{y^\alpha \gamma_t}$.
        \item For all $x,y \in \RRP$, $\left|G_t(x,y)- \tilde{G}_t(x,y)\right| \leq C(1 + x^{-\alpha})(1 + y^{-\alpha})\int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s) \dd s $.
        \item For all $x,y \in \RRP$, $\left|\partial_x \left(G_t(x,y)- \tilde{G}_t(x,y)\right)  \right| \leq C\alpha x^{-1-\alpha}(1 + y^{-\alpha})\int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s) \dd s $.
    \end{enumerate}
\end{lemma}
\begin{proof}
    ...
    and $G_t$ becomes:
    \begin{align*}
        G_t(x,y) = K_\alpha(x,y) e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\gamma_t}
    \end{align*}
    ...
    \begin{align*}
        \left|\left( h_t(x)\right)^{-1}-\left( \tilde{h}_t(x)\right)^{-1} \right| \leq (1 + x^{-\alpha})\int_0^t W_{1,\psi_1} (\mu_s,\tilde{\mu}_s)\dd s\ .
    \end{align*} 

    $(iii)$ We compute the partial derivaitve:
    \begin{align*}
    ...
    \begin{align*}
        ...
        &\leq \alpha x^{-\alpha-1}\int_0^t W_{1,\psi_1} (\mu_s,\tilde{\mu}_s)\dd s
    \end{align*}
    \red{a finir}
    ...
    $(iv)$ We have:
    \begin{align*}
        \left|G_t(x,y)\right| = K_\alpha(x,y) e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\gamma_t}
    \end{align*}
    The function $x \mapsto x^{-\alpha}$ is non increasing and $\gamma_t \geq 0$ by positivity of the solution to the $\SCE$ therefore:
    \begin{align*}
        \left|G_t(x,y)\right| \leq K_\alpha(x,y) = x^{-\alpha} + y^{-\alpha}\ .
    \end{align*}

    $(v)$ The partial derivative of $G_t$ is:
    \begin{multline*}
        \partial_x G_t(x,y) = \partial_x K_\alpha(x,y) e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\gamma_t}\\
         + K_\alpha(x,y) \int_0^t \int_{\RRP} \partial_x K_\alpha(x+y,z) - \partial _x K_\alpha(x,z)\mu_s(\dd z)\dd s\times e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\gamma_t}\ .
    \end{multline*}
    We can easily bound the first term:
    \begin{align*}
        \left| \partial_x K_\alpha(x,y) \right| e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\gamma_t} \leq \alpha x^{-1-\alpha}\ .
    \end{align*}
    As for the second term it is bounded by:
    \begin{multline*}
         K_\alpha(x,y) \int_0^t \int_{\RRP} \left|\partial_x K_\alpha(x+y,z) - \partial _x K_\alpha(x,z)\right|\mu_s(\dd z)\dd s\times  e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\gamma_t}\\
         \leq 2 \alpha  x^{-1-\alpha} K_\alpha(x,y)\gamma_t \times e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\gamma_t}\\
         \leq 2 \alpha  x^{-1-\alpha} K_\alpha(x,y)\gamma_t e^{\left((x+y)^{-\alpha} - x^{-\alpha}- y^{-\alpha}\right)\gamma_t} e^{y^\alpha \gamma_t}\ .
    \end{multline*}
    ...
    \begin{align*}
        K_\alpha(x,y) \int_0^t \int_{\RRP} \left|\partial_x K_\alpha(x+y,z) - \partial _x K_\alpha(x,z)\right|\mu_s(\dd z)\dd s\times  e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\gamma_t}\\
        \leq C_\alpha \alpha  x^{-1-\alpha}e^{y^\alpha \gamma_t}\ .
    \end{align*}
    Finally:
    \begin{align*}
        \left|\partial_x G_t(x,y)\right| \leq C_\alpha \alpha  x^{-1-\alpha}e^{y^\alpha \gamma_t}\ .
    \end{align*}

    $(vi)$ We have:
    \begin{align*}
        \left|G_t(x,y)- \tilde{G}_t(x,y)\right| &= K_\alpha(x,y)\left|e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\gamma_t} - e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\tilde{\gamma}_t} \right|\ .
    \end{align*}
    Because the term inside the exponetial is negative, the function $\gamma \mapsto e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\gamma}$ is non-decreasing therefore:
    \begin{multline*}
        \left|e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\gamma_t} - e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\tilde{\gamma}_t} \right|\\
        \leq \left|\left((x+y)^{-\alpha} - x^{-\alpha}\right)\left(\gamma_t-\tilde{\gamma}_t \right) \right| e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\gamma_t} \vee e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\tilde{\gamma}_t} \\
        \leq 2 x^{-\alpha} \left|\gamma_t-\tilde{\gamma}_t \right| e^{\left((x+y)^{-\alpha} - x^{-\alpha}\right)\left(\tilde{\gamma}_t\wedge \gamma_t\right)}
    \end{multline*}
    We have,
    \begin{align*}
        \left|\gamma_t-\tilde{\gamma}_t \right| \leq \int_0^t \left| \brac{1,\mu_s- \tilde{\mu}_s} \right| \dd s \leq \int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s) \dd s
    \end{align*}
    Finally we have:
    \begin{align*}
        \left|G_t(x,y)- \tilde{G}_t(x,y)\right| \leq x^{-\alpha} K_\alpha(x,y) \int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s) \dd s
    \end{align*}
...
\begin{align*}
    W_{1,\psi_p}(\mu,\nu) = \sup_{\substack{Lip(d_{p\alpha};f) \leq 1 \\ |f| \leq \psi_p}} \brac{f,\mu -\nu},
\end{align*}
where for a distance $d$ on $\RRP$,
\begin{align*}
    Lip(d;f) = \sup_{x,y \in \RRP} \dfrac{\left|f(x) - f(y) \right|}{d(x,y)}\ .
\end{align*}
\begin{lemma}
    For all $t \in [0,T]$ we have:
    \begin{align*}
        W_{1,\psi_2}(h_t \mu_t,\tilde{h}_t \tilde{\mu}_t) \leq W_{1,\psi_2}(\mu,\tilde{\mu}) + W_{1,\psi_1}(\mu,\tilde{\mu})\ .
    \end{align*}
\end{lemma}
\begin{proof}
    We introduce the functions:
    \begin{align*}
        H_tf(x,y) &= K_\alpha(x,y) f(x+y) h_t(x+y)\left(h_t(x)\right)^{-1}, \\
        &= f(x+y) G_t(x,y) \\
        \tilde{H}_tf(x,y) &= K_\alpha(x,y) f(x+y) \tilde{h}_t(x+y)\left(\tilde{h}_t(x)\right)^{-1}\\
        &= f(x+y) \tilde{G}_t(x,y)\ .
    \end{align*}
    Let $f$ be such that $Lip(d_{\alpha p};f) \leq 1$ and $|f| \leq \psi_p$ we have for all $t \geq 0$:
    \begin{align*}
        \brac{f,h_t\mu_t - \tilde{h}_t \tilde{\mu}_t} = \brac{f,\mu - \tilde{\mu}} + \int_0^t \brac{H_sf,\mu_s \otimes h_s\mu_s} - \brac{\tilde{H}_sf,\tilde{\mu}_s\otimes\tilde{h}_s\tilde{\mu}_s} \dd s\ .
    \end{align*}
    Breaking down the term to bound in three subparts,
    \begin{subequations}
        \begin{align}
            \brac{H_tf,\mu_t \otimes h_t\mu_t} - \brac{\tilde{H}_tf,\tilde{\mu}_t\otimes \tilde{h}_t\tilde{\mu}_t} =& \brac{H_tf,\mu_t \otimes\left(h_t\mu_t -  \tilde{h}_t \tilde{\mu}_t\right)}\label{proof:eq:h_tmu_t-1} \\
            &+ \brac{H_tf - \tilde{H}_tf,\mu_t \otimes \tilde{h}_t \tilde{\mu}_t}\label{proof:eq:h_tmu_t-2}\\
            &+ \brac{\tilde{H}_tf,\left(\mu_t-\tilde{\mu}_t\right) \otimes \tilde{h}_t \tilde{\mu}_t}\label{proof:eq:h_tmu_t-3}
        \end{align}
    ...
    where
    \begin{align*}
        A_tf(x) = \int_{\RRP} H_tf(x,y) \mu_t(\dd x)\ .
    \end{align*}
    First we bound it, by point $(iv)$ of Lemma \ref{lem:technical_G_h}:
    \begin{align*}
        \left|A_tf(x)\right| &\leq \int_{\RRP} |f(x+y)|G_t(x,y)| \mu_t(\dd x)\\
        &\leq (1 + x^{-\alpha})\int_{\RRP} (1 + (x+y)^{-p\alpha})(1 + y^{-\alpha})  \mu_t(\dd x) \\
    ...
    \end{align*}
    Which is defined for almost every $x$ since $f$ is $d_{\alpha p}$-Lipschitz. We control this partial derivaitve like so:
    \begin{align*}
    ...
    \end{align*}
    The first term can be bounded using point $(iv)$ of \ref{lem:technical_G_h}:
    \begin{align*}
        p\alpha (x+y)^{-1-p\alpha} \left|G_t(x,y) \right| &\leq p\alpha (x+y)^{-1-p\alpha} (1 + x^{-\alpha})(1 + y^{-\alpha}) 
    \end{align*} 
    Now notice that for all $a,b > 0, (x+y)^{-a - b} \leq x^{-a}y^{-b}$ therefore:
    \begin{align*}
        p\alpha (x+y)^{-1-p\alpha} \left|G_t(x,y) \right| 
        &\leq p\alpha x^{-1-\alpha} \left( y^{-(p-1)\alpha} + y^{-p\alpha } \right)(1 + y^{-\alpha}) \\
        &\leq C x^{-1-\alpha}( 1 + y^{-(p+1)\alpha})
    \end{align*}
    For the second term we use point $(v)$ of \ref{lem:technical_G_h}:
    \begin{align*}
        \left( 1 + (x+y)^{-p\alpha} \right) \left|\partial_x G_t(x,y) \right| \leq C x^{-1-\alpha}\left( 1 + (y)^{-p\alpha} \right) e^{y^{-\alpha}\gamma_t}
    \end{align*}
    By lemma \ref{lem:exponential-moments} and because $\mu \in \MC^+_{\psi_{p+1}}(\RRP)$ this function in the variable $y$. 
    Therefore $A_tf$ is almost everywhere differentiable and: 
    \begin{align*}
        \left|\partial_x A_tf(x) \right| \leq  C x^{-1-\alpha}\int_{\RRP} e^{y^{-\alpha}\gamma_t}(1 + \psi_{p+1}(y)) \mu_t(\dd y) \leq C x^{-1-\alpha}\| \mu\|_{\psi_{p+1}}\ .
    \end{align*}
    Consequently term \eqref{proof:eq:h_tmu_t-1} gets the following bound:
    \begin{align*}
        \brac{H_tf,\mu_t \otimes\left(h_t\mu_t -  \tilde{h}_t \tilde{\mu}_t\right)} &= \brac{A_tf,h_t\mu_t -  \tilde{h}_t \tilde{\mu}_t}\\
        &\leq C\| \mu\|_{\psi_{p+1}} W_{1,\psi_1}(h_t\mu_t, \tilde{h}_t \tilde{\mu}_t)\ .
    \end{align*}

    Onto \eqref{proof:eq:h_tmu_t-2},
    \begin{align*}
        \left|\brac{H_tf - \tilde{H}_tf,\mu_t \otimes \tilde{h}_t \tilde{\mu}_t}\right| &\leq \brac{\left|H_tf - \tilde{H}_tf\right|,\mu_t \otimes \tilde{h}_t \tilde{\mu}_t} 
    \end{align*}
    ...
    \begin{align*}
        \left|H_tf(x,y) - \tilde{H}_tf(x,y)\right| &\leq \left(1 + \psi_{p}(x + y) \right)\left(1 + \psi_{2}(x) \right)\left(1 + \psi_{1}(y) \right)\int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s)\dd s\\
        &\leq C \left(1 + \psi_{2}(x) \right) \left(1 + \psi_{p+1}(y) \right)\int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s)\dd s\ .
    \end{align*}
    And by Lemma \ref{lem:exponential-moments}:
    \begin{align*}
        \brac{\left|H_tf - \tilde{H}_tf\right|,\mu_t \otimes \tilde{h}_t \tilde{\mu}_t}  \leq \int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s)\dd s \|\mu\|_{\psi_2}\|\tilde{\mu}\|_{\psi_p} e^{t\|\tilde{\mu}\|_{\psi_1}}\ .
    \end{align*}
    We conclude the bound of this term using Proposition \ref{prop:wass-sce} and finally get for $t \in [0,T]$:
    \begin{align*}
        \brac{\left|H_tf - \tilde{H}_tf\right|,\mu_t \otimes \tilde{h}_t \tilde{\mu}_t}  \leq C(T,\mu,\tilde{\mu})  W_{1,\psi_1}(\mu,\tilde{\mu})\ .
    \end{align*}
    
    For the third term \eqref{proof:eq:h_tmu_t-3} we have:
    \begin{align*}
        \brac{\tilde{H}_tf,\left(\mu_t-\tilde{\mu}_t\right) \otimes \tilde{h}_t \tilde{\mu}_t} = \brac{B_tf,\mu_t-\tilde{\mu}_t},
    \end{align*}
    where
    \begin{align*}
        B_tf(y) = \int_{\RRP} \tilde{H}_tf(x,y) \tilde{h}_t(y) \tilde{\mu}_t
    \end{align*}
    \red{Bon il faut }
\end{proof}
...
\begin{proof}
    ...
    \end{align*}
    Step $1$: We show that $W_L(m_t - \tilde{m}_t) \leq W_L(h_tm_t - \tilde{h}_t\tilde{m}_t) + C(T,\mu,\tilde{\mu})d_\alpha(z_1,z_2)W_{1,\psi_1}(\mu,\tilde{\mu})$.
    ...
    \begin{multline*}
        ...
        \leq \alpha x^{-1-\alpha} (1 + x^{-\alpha })e^{-\int_0^t \int_{\RRP} K_\alpha(x,y)\tilde{\mu}_s(\dd y) \dd s}\int_0^t  W_{1,\psi_1}(\mu_s,\tilde{\mu}_s)\dd s\\
        \leq \alpha x^{-1-\alpha} \left(1 + \dfrac{1}{\int_0^t \brac{1,\tilde{\mu}_s}\dd s}\right)\int_0^t  W_{1,\psi_1}(\mu_s,\tilde{\mu}_s)\dd s 
    \end{multline*}
    ...
    \begin{multline*}
       |f'(x)|\left|\int_0^t \int_{\RRP} K_\alpha(x,y) (\mu_s-\tilde{\mu}_s)(\dd y)\dd s\right|e^{-\int_0^t \int_{\RRP} K_\alpha(x,y)\tilde{\mu}_s(\dd y) \dd s} \\
        \leq \alpha x^{-1-\alpha} C(T,\mu,\tilde{\mu})W_{1,\psi_1}(\mu,\tilde{\mu}) \left(t + \dfrac{1}{\brac{1,\tilde{\mu}_t}}\right)\ .
    \end{multline*}
    Finally the lower bound on $\brac{1,\tilde{\mu}_t}$ found in \red{Ajouter le bound} yields for $t \in [0,T]$:
    \begin{multline*}
        |f'(x)|\left|\int_0^t \int_{\RRP} K_\alpha(x,y) (\mu_s-\tilde{\mu}_s)(\dd y)\dd s\right|e^{-\int_0^t \int_{\RRP} K_\alpha(x,y)\tilde{\mu}_s(\dd y) \dd s} \\
        \leq \alpha x^{-1-\alpha} C(T,\mu,\tilde{\mu})W_{1,\psi_1}(\mu,\tilde{\mu}) \left(t + C(\|\tilde{\mu}\|_{\psi_1},\brac{1,\tilde{\mu}}) t^{\frac{1-2^{-\alpha}}{2-2^{-\alpha}}}\right) \\
        \leq \alpha x^{-1-\alpha} C(T,\mu,\tilde{\mu})W_{1,\psi_1}(\mu,\tilde{\mu})\ .
    \end{multline*}
    For the second term we have:
    \begin{multline*}
        |f(x)| \left|\int_0^t \int_{\RRP} \partial_x K_\alpha(x,y) (\mu_s-\tilde{\mu}_s)(\dd y)\dd s\right|e^{-\int_0^t \int_{\RRP} K_\alpha(x,y)\tilde{\mu}_s(\dd y) \dd s} \\
        ...
        \leq \alpha x^{-1-\alpha} \int_0^t W_{1,\psi_1}\left(\mu_s, \tilde{\mu}_s \right) \dd s\\
        \leq \alpha x^{-1-\alpha} C(T,\mu,\tilde{\mu})W_{1,\psi_1}(\mu,\tilde{\mu})\ .
    \end{multline*}
    For the third and last term \red{RAPPEL: c'est ici que l'hypothèse bounded et pas $f \leq 1 + x^{-\alpha}$ est importante}:
    \begin{align*}
        \int_0^t \int_{\RRP} K_\alpha(x,y) (\mu_s-\tilde{\mu}_s)(\dd y)\dd s &\leq (1  + x^{-\alpha}) \int_0^t W_{1,\psi_1}\left(\mu_s, \tilde{\mu}_s \right) \dd s \\
    ...
    \begin{multline*}
        ...
        \leq \alpha x^{-1-\alpha} T\brac{1,\tilde{\mu}}(1  + x^{-\alpha})e^{-\int_0^t \int_{\RRP} K_\alpha(x,y)\tilde{\mu}_s(\dd y) \dd s} \int_0^t W_{1,\psi_1}\left(\mu_s, \tilde{\mu}_s \right) \dd s \\
        \leq \alpha x^{-1-\alpha} C(T,\mu,\tilde{\mu})W_{1,\psi_1}(\mu,\tilde{\mu})\ .
    \end{multline*}
    Finally we found a constant $C(T,\mu,\tilde{\mu})$ such that:
    \[
    |g'(x)| \leq \alpha x^{-1-\alpha} C(T,\mu,\tilde{\mu}) W_{1,\psi_1}(\mu,\tilde{\mu})\ .
    \]
    Therefore by Proposition \ref{prop:wass-derivaitve} the second term in the RHS of \eqref{eq:proof:wass-finale-step-1} enjoys the bound:
    \begin{align*}
        \brac{g,\tilde{h}_t\tilde{m}_t}=\brac{g,\tilde{h}_t\left(\vphantom{A^2}\delta_\mu \varphi_t(\tilde{\mu}:z_1) - \delta_\mu \varphi_t(\tilde{\mu}:z_2)\right)} \leq d_\alpha(z_1,z_2)C(T,\mu,\tilde{\mu}) W_{1,\psi_1}(\mu,\tilde{\mu})\ .
    \end{align*}
    It finally comes that the complete expression of \eqref{eq:proof:wass-finale-step-1} is bounded as so:
    \begin{align*}
        \brac{f,m_t - \tilde{m}_t} \leq (1 + T\|\mu\|) W_L(h_tm_t - \tilde{h}_t\tilde{m}_t) + C(T,\mu,\tilde{\mu}) d_\alpha(z_1,z_2) W_{1,\psi_1}(\mu,\tilde{\mu})\ .
    \end{align*}
    This completes the first step of the proof by letting the term on the LHS got to the supremum value.

    Step $2$: Show that for all $t \in [0,T] W_{1,\psi_1}(h_tm_t - \tilde{h}_t\tilde{m}_t) \leq C(T,\mu,\tilde{\mu}) d_\alpha(z_1,z_2) W_{1,\psi_1}(\mu,\tilde{\mu})$. We start with some notations, we have for all $f \in C_b(\RR^+)$:
    \begin{align*}
    ...
    \end{align*}
    We already know from the proof of Proposition \ref{prop:wass-derivaitve} that $A_tf$ is Lpischitz with constant below $\left(1 + T\|\mu\|\right)\|\mu\|_{\psi_2}$ and therefore:
    \begin{align*}
        \brac{G_tf,h_t\mu_t \otimes \left(h_tm_t - \tilde{h}_t\tilde{m}_t \right) } &\leq \left(1 + T\|\mu\|\right)\|\mu\|_{\psi_2} W_{1,\psi_1}\left(h_tm_t -\tilde{h}_t\tilde{m}_t \right)
    \end{align*}
    ...
    The rest of this step is devoted to bounding the remaining term. We proceed similarly as in the first step by showing that $A_tf - \tilde{A}_tf$ is Lpischitz with a constant controlled by $W_{1,\psi_1}(\mu,\tilde{\mu})$ and use Proposition \ref{prop:wass-derivaitve} to conclude. We differentiate the latter function:
    \begin{align*}
