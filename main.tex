...
% %     We have for all $f$  bounded measurable:
% %     \begin{align*}
...
%     Let $\varepsilon > 0$ we have for all $f$  bounded measurable:
%     \begin{align*}
...
%     \end{align*}
%     Notice that $G_t^\varepsilon(x,y) \leq 1$. Let for $n\in \NN$, $\varepsilon_n = \frac1n$, let $p,q$ in $\NN$ we have for all $f$  bounded measurable:
%     \begin{multline*}
...
\begin{proof}
    ...
    \end{align*}
    The function $g$ is in $Lip_1(d_\alpha)$ and it is bounded by: 
    \begin{align*}
...
\begin{proof}
    ...
    \end{align*}
    For the term \eqref{proof:eq:samesame-part2}, since $z \mapsto \delta_\mu F\left(\varphi_s\left(\mu^\theta_N\right);z\right)$ lies in $Lip_1(d_\alpha)$, we have by point $1$ of Proposition \ref{prop:wass-final}:
    \begin{multline*}
