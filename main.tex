...
\[
    K_\alpha(x,y) = x^{-\alpha} + y^{-\alpha}, \quad \alpha \geq 0,
\]
which exhibits a singularity at zero and thus presents analytical challenges not addressed by most existing results. Our primary contributions are as follows:
