...
All results regarding the well-posedness of the solution to the $\SCE$ and the existence of its linear derivaitve are in Section \ref{section:well-posedness-SCE}.


The necessary proofs of the Wasserstein regularity of the $\SCE$ and its derivative are given in Section \ref{section:Wass-regularity}.
...
\begin{lemma}\label{lem:pseudo-lip-derivative-eq}
    ...
    \end{multline*}
    % \begin{align*}
    %     \sup\limits_{t \in [0,T]} \| m_t - \tilde{m}_t \|_{\phi_p} \leq C_1\|m- \tilde{m} \|_{\phi_{p}} 
    %     + C_2\|\mu- \tilde{\mu} \|_{\phi_{p+1}}.
    % \end{align*}
