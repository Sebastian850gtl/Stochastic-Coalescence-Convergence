...
\end{align*}
\end{definition}
This distance depends on the choice of $x_0$ however they are all equivalent. Another interesting property is the following.
\begin{proposition}
...
\end{proof}
Lastly it makes $\MC_d^+(\XF)$ complete. This distance can be generalized to signed measures:
...
\begin{proof}{Proof of theorem \ref{thm:main-result-2}}
    ...
    \end{multline*}
    The final result follows by the previous Lemma.
\end{proof}

\section{Conclusion and perspetives}
