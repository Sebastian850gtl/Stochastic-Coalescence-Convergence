...
\begin{lemma}\label{lem:technical_G_h}
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \item For all $x \in \RRP$,
        \[
            \left|\partial_x \left( h_t(x)\right)^{-1}- \partial_x\left( \tilde{h}_t(x)\right)^{-1} \right|\leq \alpha \left(1 + t\|\mu\| \right)x^{-1-\alpha} \left(1 + t\|\mu\| \right) \int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s) \dd s\ .
        \]
        ...
        \]
        \item For all $x,y \in \RRP$,
        \[\left|G_t(x,y)- \tilde{G}_t(x,y)\right| \leq C(1 + x^{-2\alpha})(1 + y^{-2\alpha})\int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s) \dd s \ .
        \]
        
        \item For all $x,y \in \RRP$, 
        \[\left|\partial_x \left(G_t(x,y)- \tilde{G}_t(x,y)\right)  \right| \leq C\alpha x^{-1-\alpha}(1 + x^{-\alpha})(1 + y^{-2\alpha})\int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s) \dd s\ .
        \]
    \end{enumerate}
\end{lemma}
\begin{proof}
    ...
    \begin{multline*}
        ...
        \leq K_\alpha(x,y)(1 + x^{-\alpha})(1 + y^{-\alpha}) \int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s) \dd s\\
        \leq (1 + x^{-2\alpha})(1 + y^{-2\alpha}) \int_0^t W_{1,\psi_1}(\mu_s,\tilde{\mu}_s) \dd s
    \end{multline*}
...
\begin{align*}
    W_{1,\psi_p}(\mu,\nu) = \sup_{\substack{Lip(d_{p\alpha};f) \leq 1 \\ |f| \leq 1 + \psi_p}} \brac{f,\mu -\nu},
\end{align*}

\begin{align*}
    W_{1,\beta}(\mu,\nu) = \sup_{\substack{Lip(d_{\beta};f) \leq 1 \\ |f(x)| \leq 1 + x^{-\beta }}} \brac{f,\mu -\nu},
\end{align*}
\begin{align*}
    W_{\beta}(\mu,\nu) = \sup_{\substack{Lip(d_{\beta};f) \leq 1 \\ |f(x)| \leq 1 + x^{-\beta }}} \brac{f,\mu -\nu},
\end{align*}
...
\begin{align*}
    Lip(d;f) = \sup\left\lbrace \dfrac{\left|f(x) - f(y) \right|}{d(x,y)}, (x,y) \in (\RRP)^2, x \neq y \right\rbrace \ .
\end{align*}
\begin{lemma}
...
\begin{proof}
    ...
    \begin{subequations}
        \begin{align}
            \brac{H_tf,\mu_t \otimes h_t\mu_t} - \brac{\tilde{H}_tf,\tilde{\mu}_t\otimes \tilde{h}_t\tilde{\mu}_t} =& \brac{H_tf,h_t\mu_t \otimes\left(h_t\mu_t -  \tilde{h}_t \tilde{\mu}_t\right)}\label{proof:eq:h_tmu_t-1} \\
    ...
    \begin{align*}
        ...
        \left|\partial_x G_t(x,y) \right| &\leq C x^{-1-\alpha} C x^{-1-\alpha} e^{-\int_0^t \brac{\psi_1,\mu_s}\dd s}
    \end{align*}
    We get:
    \begin{multline*}
    ...
    \begin{align*}
        \left|\partial_x A_tf(x) \right| \leq  C x^{-1-\alpha}\int_{\RRP} (1 + \psi_{p+1}(y)) e^{y^{-\alpha \gamma_t }}\mu_t(\dd y) \leq C x^{-1-\alpha}\| \mu\|_{\psi_{p+1}}\ .
    \end{align*}
    ...
    \begin{align*}
        \brac{\tilde{H}_tf,\left(h_t\mu_t-\tilde{h}_t\tilde{\mu}_t\right) \otimes \tilde{h}_t \tilde{\mu}_t} \leq C\| \tilde{\mu}\|_{\psi_{p+1}} W_{1,\psi_1}(h_t\mu_t, \tilde{h}_t \tilde{\mu}_t)\ .
    \end{align*} 
